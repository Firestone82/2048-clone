...
int main(int argc, char* argv[]) {
    ...
    game.cubes[0][0].offsetX = game.cubes[1][0].rect.x - game.cubes[0][0].rect.x;
    ...
    while (run) {
                ...
                case SDL_KEYDOWN: {
                    switch (e.key.keysym.sym) {
                        ...
                        case SDLK_a: {
                            ...
                            game.score += moveBoard(renderer, game, properties, 4);
                            moved = true;
                            break;
                        }
                        ...
                        case SDLK_d: {
                            ...
                            game.score += moveBoard(renderer, game, properties, 2);
                            moved = true;
                            break;
                        }
                        ...
                        case SDLK_w: {
                            ...
                            game.score += moveBoard(renderer, game, properties, 1);
                            moved = true;
                            break;
                        }
                        ...
                        case SDLK_s: {
                            ...
                            game.score += moveBoard(renderer, game, properties, 3);
                            moved = true;
                            break;
                        }
        ...
        //drawAnimation(renderer, game, properties);
